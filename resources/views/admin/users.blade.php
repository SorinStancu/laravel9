...
@section('cssdif')
    <link rel='preload' data-preload='1' data-minified='1' as='style' onload='this.rel="stylesheet"'
            type="text/css" href="{{ mix('assets/css/vendors/datatables.css') }}">
    <link rel='preload' data-preload='1' data-minified='1' as='style' onload='this.rel="stylesheet"'
            type="text/css" href="{{ mix('assets/css/vendors/datatable-extension.css') }}">
    <style>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <ul class="nav nav-tabs border-tab">
                            <li class="nav-item" style="margin-top:7px;">Nr. clienti: {{ $nrusers }} &nbsp;&nbsp;<strong>|</strong>
                            </li>
                            <li class="nav-item" style="margin-top:7px;">Nr. clienti cu cont: {{ $nruserscont }} &nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp;
                            </li>
                            <li class="nav-item" style="margin-top:7px;">Nr. clienti fara cont: {{ $nrusersfcont }}</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
