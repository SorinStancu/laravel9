<div>
    ...
    " x-cloak  >
        ...
        <span x-bind:class="{ 'font-bold': isName }" x-on:click="isEditing = true; $nextTick(() => focus())"  >
            {{ $sscategorie->name }}</span>
                ...
                {{--                        <div class="modal-content">--}}
                {{--                            <div class="modal-header">--}}
                {{--                                <h4 class="modal-title" id="myLargeModalLabel">Adaugare categorii</h4>--}}
                ...
                {{--                                            {{ form::label('name', 'Denumire',array('class' => 'input-group-text', 'style' => 'width:200px;' )) }}--}}
                {{--                                            {{ form::text( 'name' , '' ,[ 'class' => 'form-control' , 'placeholder' => 'Denumire', 'wire:model'=>'name']) }}--}}
                {{--                                        </div>--}}

                {{--                                        <div class='input-group input-group-lg' style='width:100%;margin-bottom:15px;'>--}}
                {{--                                            {{ form::label('idc', 'Categorie',array('class' => 'input-group-text', 'style' => 'width:200px;' )) }}--}}
                {{--                                            $items = Categories::where('active', true)->orderBy('name')->lists('name', 'id');--}}
                {{--                                            {{ form::select( 'idc',[ '-- Categorie principala --' , 'Analist QA' , 'Manager' , 'HR' ],null,[ 'class' => 'form-select form-control-primary', 'wire:model'=>'idc'])}}--}}
                {{--                                        </div>--}}

                {{--                                        <div class="input-group input-group-lg" style="width:100%;margin-bottom:15px;">--}}
                {{--                                            {{ form::label('active', 'Status',array('class' => 'input-group-text', 'style' => 'width:200px;' )) }}--}}
                {{--                                            {{ form::select( 'active',[ 'yes'=>'Activ' , 'no' =>'Inactiv'],'Activ',[ 'class' => 'form-select form-control-primary', 'wire:model'=>'active'])}}--}}
                {{--                                        </div>--}}

                {{--                                        <div class="col-md-12">--}}
                {{--                                            {{ form::button( '<i class="icofont icofont-plus"></i> Adauga' , [ 'class' => 'btn btn-success-gradien btn-lg', 'wire:click'=>'insert'])}}--}}
                {{--                                            {{ form::button( '<i class="icofont icofont-close"></i> Close' , [ 'class' => 'btn btn-secondary-gradien btn-lg', 'data-bs-dismiss'=>'modal'])}}--}}
                {{--                                        </div>--}}
    ...
    {{--    @if($ssearch===true)--}}
    {{--        @include('livewire.admin.searchcategorii')--}}
    {{--    @else--}}
    {{--        @include('livewire.admin.categorii')--}}
    {{--    @endif--}}
</div>